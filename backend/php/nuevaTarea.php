...
//VARIABLES
$id = (int) isset($_POST['id']) ? $_POST['id'] : false;
$nombreTarea = isset($_POST['nombreTarea']) ? trim($_POST['nombreTarea']) : false;
$datos = ['title' => $nombreTarea, 'id' => $id];
//CREAR DIRECTORIO
...
if ($nombreTarea !== '') {
  ...
  echo $html .= '<tr><td>No se encontraron registros</td></tr></tbody></table></div></div></div>';
}
